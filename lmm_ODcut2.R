		...
		ODL <- 0.0476
		fileFixedArray <- "LMM_28.7_OUT_var_OD__const_S.3_TL.0_TU.140_EASF.ENST_COV.1.out"
		fileRandomArray <- "LMM_28.7_OUT_var_OD__const_S.3_TL.0_TU.140_EASF.ENST_COV.1"
