...
SASFilePref = "LMM_var_Tcut_"
SASOutFileCSVnamePref = "LMM_OUT_var_Tcut_"
...
CovMatrix = 2               #1 = improved cov matrix and 2 = matrix that gives better test results but worse practical results
...
tvalues <- array(c(60, 80, 100, 120, 140, 160, 180, 200, 240, 400, 5000))
...
description = paste("_const_OD.", OD, "_S.",nSamples, "_", sero, "_COV.", CovMatrix, sep="")
